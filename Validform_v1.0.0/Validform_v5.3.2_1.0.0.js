			...
			*/
			...
			if(type==1 || triggered=="byajax" && type!=4){
                if(type==3&&(o.postType=='ajaxReturn'|| o.postType=='beforeAjax')&&o.settings&&o.settings.dialog&&dialog){
                    var opt= $.extend({id:'____Validform_',title:'提示',fixed: true,content:msg}, o.settings.dialog.settings),
                        dia,_submit=$(o.obj.context).find('[type="submit"]');
			...
			if((type==3 || type==4) && o.obj){
                //dialog({content:msg,title:'',fixed:false,align:'right'}).show(o.that);
			...
			*/
			...
			if(!flag.passed){
				...
				if(!bool){
					...
					Validform.util.showmsg.call(curform,flag.info,settings.tiptype,{obj:$(this),type:flag.type,sweep:settings.tipSweep,settings:settings,that:this},"bycheck");
			...
			if(ajaxurl && !Validform.util.isEmpty.call($(this),inputval) && !bool){
				...
				Validform.util.showmsg.call(curform,curform.data("tipmsg").c||tipmsg.c,settings.tiptype,{obj:inputobj,type:1,sweep:settings.tipSweep,settings:settings,that:this},"bycheck");
				...
				var localconfig={
					...
					success: function(data){
						if($.trim(data.status)==="y"){
							...
							Validform.util.showmsg.call(curform,inputobj.attr("sucmsg") || curform.data("tipmsg").r||tipmsg.r,settings.tiptype,{obj:inputobj,type:2,sweep:settings.tipSweep,postType:'ajaxReturn',settings:settings,ret:data,that:this},"bycheck");
